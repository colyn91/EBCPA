...
class submitAPKWorkload extends WorkloadModuleBase {
    ...
    async submitTransaction() {
        this.txIndex++;
        let apkHash = 'Hash' + this.workerIndex + '_APK' + this.txIndex.toString();
        let apk1 = apk1s[Math.floor(Math.random() * apk1s.length)];
        let apk2 = apk2s[Math.floor(Math.random() * apk2s.length)];
